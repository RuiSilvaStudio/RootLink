...
export function ProfilePurchaseRow({ order }: { order: any }) {
  return (
    <a key={order.id} href={`/marketplace/${order.listing_id}`} className="flex items-center gap-3 bg-white dark:bg-stone-900 rounded-xl border border-primary-100/40 dark:border-stone-700/40 p-3 hover:shadow-md transition" data-rl-component="ProfilePurchaseRow">
