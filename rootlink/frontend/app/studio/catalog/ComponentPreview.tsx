...
const PREVIEWS: Record<string, () => ReactNode> = {
  ...
  SeedsCanvas: () => <PreviewFrame><div className="relative w-full h-full overflow-hidden rounded-lg bg-gradient-to-br from-primary-50/40 to-transparent"><div className="absolute inset-0 grid grid-cols-6 gap-1 p-2">{Array.from({ length: 24 }).map((_, i) => <div key={i} className="w-1 h-1 rounded-full bg-primary-400/40 place-self-center" style={{ opacity: 0.2 + (i % 4) * 0.15 }} />)}</div></div></PreviewFrame>,
  VantaHalo: () => <PreviewFrame><div className="relative w-full h-full overflow-hidden rounded-lg flex items-center justify-center"><div className="w-10 h-10 rounded-full border-2 border-primary-400/40 blur-[2px]" /><div className="absolute w-6 h-6 rounded-full bg-rust-300/30 blur-sm" /></div></PreviewFrame>,
  VantaBirds: () => <PreviewFrame><div className="relative w-full h-full overflow-hidden rounded-lg"><div className="absolute top-1 left-2 text-primary-400/50 text-xs">⌃</div><div className="absolute top-2 right-3 text-earth-400/50 text-xs">⌃</div><div className="absolute bottom-2 left-4 text-rust-400/50 text-xs">⌃</div><div className="absolute bottom-1 right-2 text-primary-400/40 text-xs">⌃</div></div></PreviewFrame>,
  VantaClouds: () => <PreviewFrame><div className="relative w-full h-full overflow-hidden rounded-lg bg-gradient-to-b from-sky-100/40 to-primary-50/30"><div className="absolute top-1 left-1 w-8 h-2 rounded-full bg-white/50 blur-sm" /><div className="absolute top-3 right-2 w-6 h-1.5 rounded-full bg-white/40 blur-sm" /><div className="absolute bottom-2 left-3 w-7 h-2 rounded-full bg-white/40 blur-sm" /></div></PreviewFrame>,
  VantaTopology: () => <PreviewFrame><div className="relative w-full h-full overflow-hidden rounded-lg"><svg viewBox="0 0 100 60" className="w-full h-full"><line x1="20" y1="15" x2="50" y2="30" stroke="currentColor" strokeWidth="0.5" className="text-primary-400/40" /><line x1="50" y1="30" x2="80" y2="15" stroke="currentColor" strokeWidth="0.5" className="text-primary-400/40" /><line x1="50" y1="30" x2="35" y2="50" stroke="currentColor" strokeWidth="0.5" className="text-primary-400/40" /><line x1="50" y1="30" x2="70" y2="48" stroke="currentColor" strokeWidth="0.5" className="text-primary-400/40" /><circle cx="20" cy="15" r="1.5" className="fill-primary-500/60" /><circle cx="50" cy="30" r="2" className="fill-primary-500/60" /><circle cx="80" cy="15" r="1.5" className="fill-primary-500/60" /><circle cx="35" cy="50" r="1.5" className="fill-primary-500/60" /><circle cx="70" cy="48" r="1.5" className="fill-primary-500/60" /></svg></div></PreviewFrame>,
  AnimatedSectionBlock: () => <PreviewFrame><div className="relative w-full h-full overflow-hidden rounded-lg bg-gradient-to-br from-primary-50/50 to-transparent flex items-center justify-center"><div className="absolute w-6 h-6 rounded-full bg-primary-300/30 blur-sm top-1 left-2" /><div className="absolute w-4 h-4 rounded-full bg-earth-300/30 blur-sm bottom-1 right-2" /><TextLine text="Animated hero" className="text-[10px] font-medium relative z-10" /></div></PreviewFrame>,
