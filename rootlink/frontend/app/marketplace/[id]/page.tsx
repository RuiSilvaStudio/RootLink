...
import { MarketplaceSellerCard } from "@/components/cards/MarketplaceSellerCard";
    ...
    <div className="max-w-4xl mx-auto px-4 sm:px-8 py-12">
      ...
      <div className="grid md:grid-cols-2 gap-8">
        ...
        <div>
          ...
          {/* Seller card */}
          <MarketplaceSellerCard listing={listing} viewSellerText={t("marketplace.view_seller")} />
