        ...
        {tools.map((tool) => (
          tool.disabled ? (
            ...
            >
              ...
              <h3 className="text-lg font-serif font-bold text-stone-600 dark:text-stone-400 mb-2">{tool.name}</h3>
              <p className="text-stone-500 dark:text-stone-400 text-sm font-light">{tool.description}</p>
            ...
            >
              ...
              <h3 className="text-xl font-serif font-bold text-stone-800 dark:text-stone-100 mb-2">{tool.name}</h3>
